...
class ScreenSensor extends AwareSensor {
  static const MethodChannel _screenMethod =
      const MethodChannel('awareframework_screen/method');
  // static const EventChannel  _screenStream  = const EventChannel('awareframework_screen/event');

  static const EventChannel _onScreenOnStream =
      const EventChannel('awareframework_screen/event_on_screen_on');
  static const EventChannel _onScreenOffStream =
      const EventChannel('awareframework_screen/event_on_screen_off');
  static const EventChannel _onScreenLockStream =
      const EventChannel('awareframework_screen/event_on_screen_lock');
  static const EventChannel _onScreenUnlockStream =
      const EventChannel('awareframework_screen/event_on_screen_unlock');

  StreamController<dynamic> onScreenOnStreamController =
      StreamController<dynamic>();
  StreamController<dynamic> onScreenOffStreamController =
      StreamController<dynamic>();
  StreamController<dynamic> onScreenLockStreamController =
      StreamController<dynamic>();
  StreamController<dynamic> onScreenUnlockStreamController =
      StreamController<dynamic>();
  ...
  /// ```
  ScreenSensor() : this.init(ScreenSensorConfig());
  ...
  Stream<dynamic> get onScreenOn {
    onScreenOnStreamController.close();
    onScreenOnStreamController = StreamController<dynamic>();
    return onScreenOnStreamController.stream;
  }

  Stream<dynamic> get onScreenOff {
    onScreenOffStreamController.close();
    onScreenOffStreamController = StreamController<dynamic>();
    return onScreenOffStreamController.stream;
  }

  Stream<dynamic> get onScreenLocked {
    onScreenLockStreamController.close();
    onScreenLockStreamController = StreamController<dynamic>();
    return onScreenLockStreamController.stream;
  }

  Stream<dynamic> get onScreenUnlocked {
    onScreenUnlockStreamController.close();
    onScreenUnlockStreamController = StreamController<dynamic>();
    return onScreenUnlockStreamController.stream;
  }
  ...
  Future<Null> start() {
    ...
    super
        .getBroadcastStream(_onScreenOffStream, "on_screen_off")
        .listen((event) {
    ...
    super
        .getBroadcastStream(_onScreenLockStream, "on_screen_locked")
        .listen((event) {
    ...
    super
        .getBroadcastStream(_onScreenUnlockStream, "on_screen_unlocked")
        .listen((event) {
